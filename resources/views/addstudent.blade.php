            ...
            <nav>
                <menu>
                    ...
                    <ul>
                        ...
                        <li><a class="active" href="{{ url('/addstudent') }}">
                ...
                <h1>Add Student</h1>
                    <form class="form" action="{{ route('students.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="con">
                            <div class="label">
                                <label>ชื่อ</label> <br>
                                <input type="text" id="name" name="first_name" placeholder="ใส่ชื่อ" required>
                            </div>
                            <div class="label">
                                <label>นามสกุล</label> <br>
                                <input type="text" id="name" name="last_name" placeholder="ใส่นามสกุล" required>
                            </div>
                            <div class="label">
                                <label>สาขาวิชา</label> <br>
                                <input type="text" id="name" name="major" placeholder="ใส่สาขาวิชา" required>
                            </div>
                            <div class="label">
                                <label>รหัสนักศึกษา</label> <br>
                                <input type="text" id="name" name="student_id" placeholder="ใส่รหัสนักศึกษา" required>
                            </div>
                        </div>
